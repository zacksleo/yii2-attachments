...
namespace zacksleo\yii2\attachments;

use zacksleo\yii2\attachments\models\File;
...
class Module extends \yii\base\Module
{
    ...
    {
        \Yii::$app->i18n->translations['zacksleo/yii2/attachments/*'] = [
            'class' => PhpMessageSource::className(),
            'sourceLanguage' => 'en',
            'basePath' => '@vendor/zacksleo/yii2-attachments/src/messages',
            'fileMap' => [
                'zacksleo/yii2/attachments' => 'attachments.php'
            ],
        ];
    }
    ...
    {
        return \Yii::t('zacksleo/yii2/' . $category, $message, $params, $language);
    }
